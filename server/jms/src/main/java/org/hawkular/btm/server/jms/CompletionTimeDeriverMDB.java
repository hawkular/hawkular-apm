...
@MessageDriven(name = "BusinessTransaction_CompletionTimeDeriver", messageListenerInterface = MessageListener.class,
        activationConfig =
        {
                ...
                @ActivationConfigProperty(propertyName = "clientId", propertyValue = "CompletionTimeDeriver"),
                @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "CompletionTimeDeriver")
        })
