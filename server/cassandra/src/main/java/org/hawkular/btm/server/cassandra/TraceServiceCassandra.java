...
public class TraceServiceCassandra implements TraceService {
    ...
    public List<Trace> query(String tenantId, Criteria criteria) {
        ...
        StringBuilder statement = new StringBuilder("SELECT doc FROM hawkular_btm.traces");
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.api.services.TraceService#storeBusinessTransactions(java.lang.String,
     *                          java.util.List)
     */
    @Override
