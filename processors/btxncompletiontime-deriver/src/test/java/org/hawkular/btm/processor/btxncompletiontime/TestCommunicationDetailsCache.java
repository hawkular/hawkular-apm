...
public class TestCommunicationDetailsCache implements CommunicationDetailsCache {
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.processor.btxncompletiontime.CommunicationDetailsCache#getSingleConsumer(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.processor.btxncompletiontime.CommunicationDetailsCache#store(java.util.List)
     */
    @Override
