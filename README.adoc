...
[link=https://issues.jboss.org/issues?jql=project%20%3D%20HWKAPM%20AND%20status%20%3D%20Open]
image::https://img.shields.io/badge/Jira-issues-blue.svg[Build Status]
endif::[]
