...
public class InstrumentConsumerTransformer extends CollectorActionTransformer {
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.instrumenter.config.InstrumentInvocationTransformer#getEntity()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.instrumenter.config.InstrumentInvocationTransformer#getParameters()
     */
    @Override
