...
public class InstrumentComponentTransformer extends CollectorActionTransformer {
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.instrumenter.config.InstrumentActionTransformer#getEntity()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.instrumenter.config.InstrumentActionTransformer#getParameters()
     */
    @Override
