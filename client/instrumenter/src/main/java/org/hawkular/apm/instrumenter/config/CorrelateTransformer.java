...
import org.hawkular.apm.api.model.config.instrumentation.Correlate;
import org.hawkular.apm.api.model.config.instrumentation.InstrumentAction;

/**
 * This class transforms the Correlate action type.
 *
 * @author gbrown
 */
public class CorrelateTransformer implements InstrumentActionTransformer {
    ...
    public String convertToRuleAction(InstrumentAction action) {
        ...
        builder.append("correlate(");

        builder.append(correlateAction.getIdExpression());
