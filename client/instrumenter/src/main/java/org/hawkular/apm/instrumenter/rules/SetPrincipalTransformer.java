...
import org.hawkular.apm.api.model.config.instrumentation.jvm.SetPrincipal;

/**
 * This class transforms the SetPrincipal action type.
 *
 * @author gbrown
 */
public class SetPrincipalTransformer implements InstrumentActionTransformer {
    ...
    public String convertToRuleAction(InstrumentAction action) {
        ...
        builder.append("setPrincipal(getRuleName(),");
