 ...
 */
package org.hawkular.btm.trace.publisher.rest.client;
...
public class TracePublisherRESTClient implements TracePublisher {
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.api.services.TracePublisher#publish(java.lang.String, java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.hawkular.btm.api.services.TracePublisher#isEnabled()
     */
    @Override
