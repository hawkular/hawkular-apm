    ...
    protected void testStoreAndQueryNodeDetails(int numberOfBatches, int batchSize) throws Exception {
        ...
        for (int i = 0; i < numberOfBatches; i++) {
            ...
            for (int j = 0; j < batchSize; j++) {
                ...
                nd.getProperties().put("apm:hostName", nd.getHostName());
                nd.getProperties().put("apm:prop1", nd.getHostName());
                nd.getProperties().put("apm:prop2", nd.getHostName());
                nd.getProperties().put("apm:prop3", nd.getHostName());
                nd.getProperties().put("apm:prop4", nd.getHostName());
                nd.getProperties().put("apm:prop5", nd.getHostName());
                nds.add(nd);
            }
        ...
        //criteria.addProperty("apm:hostName", "host5", false);
