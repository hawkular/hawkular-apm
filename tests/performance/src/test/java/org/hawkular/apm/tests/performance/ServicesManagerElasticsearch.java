...
import org.hawkular.apm.server.elasticsearch.ConfigurationServiceElasticsearch;
...
public class ServicesManagerElasticsearch implements ServicesManager {
    ...
    public ServicesManager init() throws Exception {
        if (!System.getProperties().containsKey("hawkular-apm.data.dir")) {
            System.setProperty("hawkular-apm.data.dir", "target/data");
        }
