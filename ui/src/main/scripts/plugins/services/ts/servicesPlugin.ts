...
/// <reference path="servicesGlobals.ts"/>
module Services {

  export var _module = angular.module(Services.pluginName, ['ui.bootstrap', 'patternfly.select']);
  ...
  hawtioPluginLoader.addModule(Services.pluginName);
}
