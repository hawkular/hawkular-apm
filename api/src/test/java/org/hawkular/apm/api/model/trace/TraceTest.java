...
public class TraceTest {
    ...
    protected Trace example1() {
        ...
        c1.getCorrelationIds().add(new CorrelationIdentifier(Scope.Node, "CID2"));
        c1.setDuration(1000);
        c1.setBaseTime(1);
        ...
        s2.getCorrelationIds().add(new CorrelationIdentifier(Scope.Association, "CID3"));
        s2.setDuration(500);
        s2.setBaseTime(3);
        s2.setOperation("Op2");
        ...
        c1.getCorrelationIds().add(new CorrelationIdentifier(Scope.Association, "CID3"));
        c1.getCorrelationIds().add(new CorrelationIdentifier(Scope.Fragment, "CID4"));
        c1.setDuration(400);
        c1.setBaseTime(4);
