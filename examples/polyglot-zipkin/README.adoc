...
* https://github.com/openzipkin/zipkin-ruby/issues/68[Ruby instrumentation: HTTP_X_B3_SAMPLED incorrect resulting in
broken traces], https://github.com/openzipkin/zipkin-ruby/pull/69[pull/69]
